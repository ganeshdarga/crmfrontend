...
const Activities = () => {
  ...
  const addActivitys =()=>{
    Axios.post("https://demo3-5.onrender.com/api/v1/activities/addactivity/",{
      addDate:addDate,
      addDay:addDay,
  ...
  const submitdeletedata = (id)=>{
    Axios.delete("https://demo3-5.onrender.com/api/v1/activities/deleteactivity/",{data:{deleteId:deleteId}
    }).then((res)=>{
  ...
  const submiteditdata = ()=>{
    if (addDate === "" || addDay === "" || addStarttime === "" || addEndtime === "" || addDis === "" ){
      ...
      Axios.post(`https://demo3-5.onrender.com/api/v1/activities/editactivity/?id=${id}`,{
        addDate:addDate,
        addDay:addDay,
        addStarttime:addStarttime,
        addEndtime:addEndtime,
