...
const Tasks = () => {
  ...
  const gettasks = ()=>{
    Axios.get("https://crmbackend-67.onrender.com/api/v1/tasks/",{
    }).then((res)=>{
  ...
  const addtaskdata=()=>{
    if( taskname === "" || deadline ==="" || taskstatus === "" || taskassignee ===""){
      ...
      Axios.post("https://crmbackend-67.onrender.com/api/v1/tasks/addtask/",{
        taskname:taskname,
        deadline:deadline,
  ...
  const submitdeletedata1 = (id)=>{
    Axios.delete("https://crmbackend-67.onrender.com/api/v1/tasks/deletetask/",{data:{Id1:Id1
    }}).then((res)=>{
  ...
  const submiteditdata = ()=>{
    if (taskname === "" || deadline === "" || taskstatus === "" || taskassignee === ""){
      ...
      Axios.post(`https://crmbackend-67.onrender.com/api/v1/tasks/edittask/?id=${id}`,{
        taskname:taskname,
        deadline:deadline,
        taskstatus:taskstatus,
        taskassignee:taskassignee,
