...
const DealTickets = () => {
  ...
  const tickestlist = () => {
    Axios.get("https://crmbackend-1-9mff.onrender.com/api/v1/ticket/").then((response) => {
  ...
  function UpdateStatus(id) {
    Axios.post(`https://crmbackend-1-9mff.onrender.com/api/v1/ticket/setupdatestatus/?id=${id}`, {
      textarea: textarea,
    })
      .then((res) => {
        tickestlist();
