...
const Invoice = () => {
  ...
  const getinvoice = ()=>{
    Axios.get("https://crmbackendso.onrender.com/api/v1/invoice/",{
    }).then((res)=>{
  ...
  const addinvoicedata=()=>{
    if( accountnumber === "" || account ==="" || amount === "" || invoicedate ==="" || duedate ==="" || type === "" || status ===""){
      ...
      Axios.post("https://crmbackendso.onrender.com/api/v1/invoice/addinvoice/",{
  ...
  const submitdeletedata = (id)=>{
    Axios.delete("https://crmbackendso.onrender.com/api/v1/invoice/deleteinvoice/",{data:{deleteId:deleteId}
    }).then((res)=>{
  ...
  const submiteditdata = ()=>{
    if (accountnumber === "" || account === "" || amount === "" || invoicedate === "" || duedate === ""  || type === "" || status ==="" ){
      ...
      Axios.post(`https://crmbackendso.onrender.com/api/v1/invoice/subinvoiceedit/?id=${id}`,{
        accountnumber:accountnumber,
        account:account,
        amount:amount,
        invoicedate:invoicedate,
