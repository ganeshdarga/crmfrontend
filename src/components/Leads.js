...
const Leads = () => {
  ...
  const getleads = ()=>{
    Axios.get("https://crmbackend-67.onrender.com/api/v1/leads/",{
    }).then((res)=>{
  ...
  const addleadsdata=()=>{
    if( leadname === "" || leadtitle ==="" || leadcompany === "" || leadphone ==="" || leademail ==="" || lead_status ==="" || leadcreate ==="" || leadowner===""){
      ...
      Axios.post("https://crmbackend-67.onrender.com/api/v1/leads/addleads/",{
        leadname:leadname,
        leadtitle:leadtitle,
  ...
  const submitdeletedata = (id)=>{
    Axios.delete("https://crmbackend-67.onrender.com/api/v1/leads/deteteleaddata/",{data:{deleteId:deleteId}
    }).then((res)=>{
  ...
  const submiteditdata = ()=>{
    if (leadname === "" || leadtitle === "" || leadcompany === "" || leadphone === "" || leademail === "" || lead_status ==="" || leadcreate ==="" || leadowner===""){
      ...
      Axios.post(`https://crmbackend-67.onrender.com/api/v1/leads/leadedit/?id=${id}`,{
        leadname:leadname,
        leadtitle:leadtitle,
        leadcompany:leadcompany,
        leadphone:leadphone,
