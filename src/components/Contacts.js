...
const Contacts = () => {
  ...
  const getUserdata = () => {
    Axios.get("https://demo3-5.onrender.com/api/v1/user/", {}).then((res) => {
  ...
  const submiteditdata = () => {
    if (
      ...
      Axios.post(`https://demo3-5.onrender.com/api/v1/user/submitedit/?Id=${Id}`, {
        Username: Username,
        userEmail: userEmail,
  ...
  const submitdeletedata1 = () => {
    Axios.delete("https://demo3-5.onrender.com/api/v1/user/submitdelete/", {data:{Id1:Id1}}).then(
      (res) => {
