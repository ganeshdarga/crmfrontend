...
const Contacts = () => {
  ...
  const getUserdata = () => {
    Axios.get("https://crmbackend-1-9mff.onrender.com/api/v1/user/", {}).then((res) => {
  ...
  const submiteditdata = () => {
    if (
      ...
      Axios.post(`https://crmbackend-1-9mff.onrender.com/api/v1/user/submitedit/?Id=${Id}`, {
        Username: Username,
        userEmail: userEmail,
  ...
  const submitdeletedata1 = () => {
    Axios.delete("https://crmbackend-1-9mff.onrender.com/api/v1/user/submitdelete/", {data:{Id1:Id1}}).then(
      (res) => {
