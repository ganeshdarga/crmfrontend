...
const Companies = () => {
  ...
  const getcompanies = ()=>{
    Axios.get("https://crmbackend-1-9mff.onrender.com/api/v1/companies/",{
    }).then((res)=>{
  ...
  const addcompanydata=()=>{
    if( companyname === "" || companyemail ==="" || comapanymobile === "" || companymanage ==="" || companystatus ===""){
      ...
      Axios.post("https://crmbackend-1-9mff.onrender.com/api/v1/companies/addcompany/",{
  ...
  const submitdeletedata = (id)=>{
    Axios.delete("https://crmbackend-1-9mff.onrender.com/api/v1/companies/detetecompanydata/",{data:{deleteId:deleteId}
    }).then((res)=>{
  ...
  const submiteditdata = ()=>{
    if (companyname === "" || companyemail === "" || comapanymobile === "" || companymanage === "" || companystatus === "" ){
      ...
      Axios.post(`https://crmbackend-1-9mff.onrender.com/api/v1/companies/subcompanyedit/?id=${id}`,{
        companyname:companyname,
        companyemail:companyemail,
        comapanymobile:comapanymobile,
        companymanage:companymanage,
